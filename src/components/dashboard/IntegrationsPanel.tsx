        ...
        <div className="mt-2 space-y-4">
          <div className="bg-success/10 p-3 rounded border border-success/20">
            <p className="text-[11px] font-bold text-destructive mb-2 whitespace-pre-wrap">
              {`gam 2026-08-23..2026-08-23 200: {"ok":true,"date_preset":"LAST_7_DAYS","summary":[{"network_code":"22953977775","error":"ReferenceError: siteMetricsOnly is not defined"}],"gam_debug":{"gam_called":true,"rows_returned":0,"date_range":[],"site":"28404d69-ba48-432c-ae7c-2610f79ab81f","error":"ReferenceError: siteMetricsOnly is not de"}`}
            </p>
