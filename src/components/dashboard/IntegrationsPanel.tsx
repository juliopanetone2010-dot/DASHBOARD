  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 text-xs text-muted-foreground">
        ...
        voce precisa ajustar as campanhas tb, dessa forma nao consigo ter nocao em qual campanha ta tendo roi, so o roi geral, pq as receita das cas campanhas estao geradas?
      </div>
