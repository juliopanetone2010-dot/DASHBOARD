...
export function CampaignsTable({ campaigns, campaignGamMetrics, campaignMatchRates, campaignBestMatches, downAccountIds, onPause, onBoost, onRefresh, dateRange, siteId, isIntraday = false }: Props) {
  ...
  const HEAD_DEFS: Record<ColKey, HeadDef> = {
    ...
    revenue: { label: isIntraday ? "agora vou poder ver o roi das campanhas?" : "Receita", sortKey: "revenue", align: "right" },
    profit: { label: isIntraday ? "agora vou poder ver o roi das campanhas?" : "Lucro", sortKey: "profit", align: "right" },
    roi: { label: isIntraday ? "agora vou poder ver o roi das campanhas?" : "ROI", sortKey: "roi", align: "right" },
