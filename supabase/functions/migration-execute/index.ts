...
async function runMigration(a: RunArgs) {
  ...
  const srcBase = `https://googleads.googleapis.com/v25/customers/${srcAcc.customer_id}`;
  const dstBase = `https://googleads.googleapis.com/v25/customers/${dstAcc.customer_id}`;
