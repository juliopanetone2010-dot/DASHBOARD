...
async function runMigration(a: RunArgs) {
  ...
  const srcBase = `https://googleads.googleapis.com/v19/customers/${srcAcc.customer_id}`;
  const dstBase = `https://googleads.googleapis.com/v19/customers/${dstAcc.customer_id}`;
