    ...
    try {
      for (const root of accounts) {
        ...
        if (root.is_mcc) {
          ...
          const cRes = await fetchWithRetry(`https://googleads.googleapis.com/v24/customers/${root.customer_id}/googleAds:search`, {
            method: "POST",
        ...
        for (const leaf of leafAccounts) {
          ...
          try {
            ...
            const camRes = await fetchWithRetry(`https://googleads.googleapis.com/v24/customers/${leaf.customer_id}/googleAds:search`, {
