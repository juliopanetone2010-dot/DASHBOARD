    ...
    try {
      for (const root of accounts) {
        ...
        if (root.is_mcc) {
          ...
          const cUrl = `https://googleads.googleapis.com/v17/customers/${root.customer_id}/googleAds:search`;
        ...
        for (const leaf of leafAccounts) {
          ...
          try {
            ...
            const camUrl = `https://googleads.googleapis.com/v17/customers/${leaf.customer_id}/googleAds:search`;
