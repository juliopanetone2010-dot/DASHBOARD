    ...
    for (const g of groups.values()) {
      try {
        ...
        const sr = await fetch(
          `https://googleads.googleapis.com/v25/customers/${g.acc.customer_id}/googleAds:search`,
        ...
        if (operations.length === 0) {
          ...
          const mr = await fetch(
            `https://googleads.googleapis.com/v25/customers/${g.acc.customer_id}/campaignCriteria:mutate`,
