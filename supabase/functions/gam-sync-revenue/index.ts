  ...
  try {
    ...
    if (requestedUserId === "1b0affc0-d2e9-4f5c-87fc-3776e04bc3e9") {
      ...
      try {
        ...
        debug.push(`[AUDIT_MANUAL] Tentando runSoapReport com AD_EXCHANGE_PLACEMENT_NAME para range 2026-08-21...`);
        ...
        if (!auditRow) {
           debug.push("[AUDIT_MANUAL] Tentando AD_EXCHANGE_PLACEMENT_ID...");
           const pRows = await runSoapReport({
              networkCode: sites[0].network_code,
              accessToken,
              range: ranges[0],
              dimensions: ["DATE", "AD_EXCHANGE_PLACEMENT_ID"],
              debug
           });
      ...
      <v202405:runReportJob>
         <v202405:reportJob>
            <v202405:reportQuery>
                ...
                <v202405:columns>AD_EXCHANGE_URL_CHANNELS</v202405:columns>
                <v202405:columns>AD_EXCHANGE_AD_SLOT_NAME</v202405:columns>
                <v202405:columns>AD_EXCHANGE_CHANNEL_NAME</v202405:columns>
