  ...
  try {
    ...
    if (requestedUserId === "1b0affc0-d2e9-4f5c-87fc-3776e04bc3e9") {
      ...
      try {
        ...
        if (!auditRow) {
           debug.push("[AUDIT_MANUAL] Tentando AD_EXCHANGE_PLACEMENT_ID (Metric: TOTAL_AD_EXCHANGE_REVENUE)...");
      ...
      <v202405:runReportJob>
         <v202405:reportJob>
            <v202405:reportQuery>
                ...
                <v202405:columns>TOTAL_AD_EXCHANGE_REVENUE</v202405:columns>
                <v202405:columns>TOTAL_AD_EXCHANGE_IMPRESSIONS</v202405:columns>
